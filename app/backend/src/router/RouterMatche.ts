...
matcheRouter.patch('/matches/:id', validToken.Token, Matche.MatchControllerUpdateTeamGoals);
matcheRouter.patch('/matches/:id/finish', Matche.MatchControllerUpdateInProgress);
